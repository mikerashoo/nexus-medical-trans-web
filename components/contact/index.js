import NEXUS_ADDRESS from "../utils/address";
import RequestForm from "./RequestForm";

const ContactSection = () => {
    return ( 
<section id="contact" className="bg-slate-100 p-10 lg:p-20 lg:py-[120px] overflow-hidden relative z-10">
            ...
            <div className="max-w-[570px] mb-12 lg:mb-0">
               ...
               <div className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                     ...
                     <p className="text-base text-body-color">{NEXUS_ADDRESS.phoneNumber}</p>
                  </div>
               </div>
               <div className="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div className="w-full">
                     ...
                     <p className="text-base text-body-color">{NEXUS_ADDRESS.email}</p>
                  </div>
               </div>
            </div>
         </div>
